        ...
        try (Scanner sc = new Scanner(new File(RESOURCE))) {
            ...
            while (sc.hasNextLine()) {
                ...
                try {
                    ...
                    int numSeat = Integer.parseInt(properties[5]);
                    int price = Integer.parseInt(properties[6]);
                    boolean visible = Boolean.parseBoolean(properties[7]);
                    Flight flight = new Flight(id, flightNumber, origin, destination, departureDate, numSeat, price, visible);
    ...
    public void storeData(FlightBookingSystem fbs) throws IOException {
        try (PrintWriter out = new PrintWriter(new FileWriter(RESOURCE))) {
            for (Flight flight : fbs.getFlights()) {
                ...
                out.print(flight.getNumSeat() + SEPARATOR);
                out.print(flight.getPrice() + SEPARATOR);
                out.print(flight.isVisible() + SEPARATOR);
                out.println();
            }
        }
    }
